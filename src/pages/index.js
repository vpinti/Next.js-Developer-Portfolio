        ...
        <Layout className='pt-0 md:pt-16 sm:pt-8'>
          <div className="flex items-center justify-between w-full lg:flex-col">
            <div className='w-1/2 md:w-full'>
              <Image src={profilePic} alt="Vittorio Pinti" className='w-full h-auto lg:hidden md:inline-block md:w-full' 
              priority
              sizes='(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw' 
              />
            </div>
            <div className='w-1/2 flex flex-col item-center self-center lg:w-full lg:text-center'>
              <AnimatedText text="Building Reliable Backends That Power Great Products." className='!text-6xl !text-left xl:!text-5xl lg:!text-center
              lg:!text-6xl md:!text-5xl sm:!text-3xl
              '/>
              <p className='my-4 text-base font-medium md:text-sm sm:text-xs'>
              As a Senior Backend Developer with over 8 years of experience, I build robust enterprise web
              applications, well-designed APIs and solid CI/CD pipelines. Explore my latest projects and articles on
              backend development, API design and legacy modernization.
              </p>
              <div className='flex items-center self-start mt-2 lg:self-center'>
                <Link href='/CVPintiVittorio-web.pdf' target={'_blank'}
                ...
                <Link href='mailto:vittorio.pinti@gmail.com'
